<?php include('header.php');?>
  ...
  <!--Intro-->
  <div id="intro">
      <div id="abc_nanotech"><h1 class="text-align-center" style="padding-top:40px;padding-bottom:0px;color: #fff;font-weight:bold;font-size:48px">Baby Care Products</h1></div>
