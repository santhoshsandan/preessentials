<?php include('header.php');?>
  ...
  <!--Intro-->
  <div id="intro">
      <div id="covestro"><h1 class="text-align-center" style="padding-top:40px;padding-bottom:0px;color: #fff;font-weight:bold;font-size:48px">Soap and Cleaners Products</h1></div>
      <div class="container" style="margin-top:50px;">
          <div class="row">
            ...
            <div class="col-lg-3 animated zoomIn Slow">
              <img src="img/Covestro_logo.svg.png" width="50%"/>
              <?php include('for.php');?>
            </div>
          </div>
      </div>
