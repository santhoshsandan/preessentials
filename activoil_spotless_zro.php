<?php include('header.php');?>
  ...
  <!--Intro-->
  <div id="intro">
      <div id="innovacos"><h1 class="text-align-center" style="padding-top:10px;padding-bottom:0px;color: #fff;font-weight:normal;font-size:80px;">Activoil™ Spotless ZRO</h1></div>
      <div class="container" style="margin-top:50px;">
          <div class="row">
            <div class="col-lg-9 animated zoomIn Slow">
              <!-- <iframe src="doc/bioptimized_guava.pdf" width="100%" height="600px"></iframe> -->
              <!-- <embed src="doc/activoil_spotless_zro.pdf" type="application/pdf"   height="600px" width="100%"> -->
              <img src="img/innovacos/product/activoil_spotless_zro.jpg" class="img-thumbnail" width="100%"/>
