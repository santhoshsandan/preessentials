<?php include('header.php');?>
  ...
  <!--Intro-->
  <div id="intro">
      <div id="saint_gobain"><h1 class="text-align-center" style="padding-top:20px;padding-bottom:0px;color: #fff;font-weight:normal;font-size:80px;">TRÈS BN® Cosmetic Powders PUHP1106 and PUHP1107</h1></div>
      <div class="container" style="margin-top:50px;">
          <div class="row">
            <div class="col-lg-9 animated zoomIn Slow">
              <!-- <iframe src="doc/bioptimized_guava.pdf" width="100%" height="600px"></iframe> -->
              <!-- <embed src="doc/regenesea_ls.pdf" type="application/pdf"   height="600px" width="100%"> -->
              <img src="img/saint/TRESBN_Surface-1.jpg" class="img-thumbnail" width="100%"/>
              <img src="img/saint/TRESBN_Surface-2.jpg" class="img-thumbnail" width="100%"/>
