...
<style>
  ...
  <!--Intro-->
  <div id="intro">
      <div id="oats"><h1 class="text-align-center" style="padding-top:10px;padding-bottom:0px;color: #fff;font-weight:normal;font-size:80px;">Skin Care Products</h1></div>
          ...
          <div class="row">
            <div class="col-lg-9 animated zoomIn Slow">
                ...
                <table id='myTable' class='table table-striped table-bordered' style='width:100%'>
                  ...
                  <tbody>
                    <tr>
                      <td><span style="font-weight:bold;">aura</span><i style="font-weight:normal!important;">firm</i></td>
                      <td>Lactobacillus Ferment, Avena sativa Kernel Extract, Sodium Benzoate, Potassium Sorbate</td>
                      <td>Natural oat fermented actives, which improve skin health</td>
                      <td><a href="aurafirm.php" class="btn btn-warning" role="button">View Product</a></td>
                    </tr>
                    <tr>
                      <td>AvenaPLex</td>
