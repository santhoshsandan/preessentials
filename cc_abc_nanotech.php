...
.btn{
  ...
  <!--Intro-->
  <div id="intro">
      <div id="abc_nanotech"><h1 class="text-align-center" style="padding-top:10px;padding-bottom:0px;color: #fff;font-weight:normal;font-size:80px;">Colour Cosmetics Products</h1></div>
