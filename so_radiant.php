...
<style>
  ...
  <!--Intro-->
  <div id="intro">
      <div id="radiant"><h1 class="text-align-center" style="padding-top:10px;padding-bottom:0px;color: #fff;font-weight:normal;font-size:80px;">Soap and Cleaners Products</h1></div>
