...
<style>
  ...
  <!--Intro-->
  <div id="intro">
        <div id="innovacos"><h1 class="text-align-center" style="padding-top:10px;padding-bottom:0px;color: #fff;font-weight:normal;font-size:80px;">Hair Care Products</h1></div>
