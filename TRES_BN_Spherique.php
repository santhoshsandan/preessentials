<?php include('header.php');?>
  ...
  <!--Intro-->
  <div id="intro">
      <div id="saint_gobain"><h1 class="text-align-center" style="padding-top:10px;padding-bottom:0px;color: #fff;font-weight:normal;font-size:80px;">TRES BN Spherique - PUHP 50S</h1></div>
      <div class="container" style="margin-top:50px;">
          <div class="row">
            <div class="col-lg-9 animated zoomIn Slow">
              ...
              <img src="img/saint/TRESBN50s.jpg" class="img-thumbnail" width="100%"/>
